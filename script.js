(() => {
  ...
  function messageFor(name, url) {
    return `🦚 શ્રી કૃષ્ણ જન્માષ્ટમીની હાર્દિક શુભેચ્છાઓ 🦚\n\n${name} તરફથી તમને જન્માષ્ટમીની ખૂબ ખૂબ શુભેચ્છાઓ. 🙏\n\nભગવાન શ્રીકૃષ્ણની કૃપા અને આશીર્વાદથી તમારા જીવનમાં સુખ, શાંતિ, સમૃદ્ધિ અને પ્રેમ સદાય બની રહે.\n\nઆ ખાસ શુભેચ્છા અહીં જુઓ:\n${url}`;
  }
  ...
  nativeShare.addEventListener("click", async () => {
    ...
    const data = {
      ...
      text: `${name} તરફથી આપને અને આપના પરિવારને શ્રી કૃષ્ણ જન્માષ્ટમીની હાર્દિક શુભેચ્છાઓ. 🙏`,
      url
    };
  ...
  shareTelegram.addEventListener("click", () => {
    ...
    if (!name) return;
    const url = makeURL(name);
    openApp(`https://t.me/share/url?url=${encodeURIComponent(url)}&text=${encodeURIComponent(`${name} તરફથી આપને અને આપના પરિવારને શ્રી કૃષ્ણ જન્માષ્ટમીની હાર્દિક શુભેચ્છાઓ. 🙏`)}`);
  });
